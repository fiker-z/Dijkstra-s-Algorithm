...
public class Vertex {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof Vertex)) { //needs to compare 2 vertex objects
      return false;
    }
    Vertex oVertex = (Vertex) o; //casts object to vertex

    return name.equals(oVertex.name) && x == oVertex.x && y == oVertex.y;
  }

  public void addEdge(Edge edge) {
    adjacentEdges.add(edge); //adds edge to LL of edges
  }

  public String toString() {
    return name + " (" + x + ", " + y + ")";//returns vertex name + its coordinates
  }
